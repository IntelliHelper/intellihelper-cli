...
//!
//! ```text
//! <cwd>/.intellihelper/rewind-checkpoints/
...
/// Directory (under `<cwd>/.intellihelper`) holding every session's checkpoint store.
...
pub(crate) struct CheckpointStore {
    /// Per-session store directory: `<cwd>/.intellihelper/rewind-checkpoints/<session_id>`.
    dir: PathBuf,
