...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "intellihelpernight",
        display: "IntelliHelper Night",
        description: "Neutral dark with magenta accent.",
    },
    EnumChoice {
        canonical: "intellihelperday",
        display: "IntelliHelper Day",
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain intellihelper in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain intellihelper in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `intellihelper_voice::STT_LANGUAGES` (official IntelliHelper STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain intellihelper opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "intellihelpernight".
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "intellihelpernight".
                default: "intellihelpernight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "intellihelperday".
                default: "intellihelperday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
            restart_required: false,
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "intellihelper", "switch"],
        ...
        // The `INTELLIHELPER_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // follows the process locale when it maps to a IntelliHelper STT language.
        // Catalog = official STT languages (see intellihelper_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (IntelliHelper STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "Show a `/doctor` tip when an SSH session is not using `intellihelper wrap`.",
            keywords: &[
                "ssh",
                "wrap",
                "remote",
