...
//!
//! These types support the feedback collection system for IntelliHelper sessions.
//! The agent (intellihelper-shell) uses heuristics to determine when to request feedback,
...
pub struct FeedbackSubmission {
    ...
    /// Shell (intellihelper-shell) version
    #[serde(skip_serializing_if = "Option::is_none")]
...
fn default_tier1_prompt() -> String {
    "You've been using IntelliHelper Code productively! Would you mind sharing quick feedback?".to_string()
}
