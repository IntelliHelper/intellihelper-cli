...
pub fn collect_startup_tui<'a>(
    ...
    let native_tool = startup_native_tool(is_wayland, || {
        intellihelper_shell::util::clipboard::native_tool_name()
    });
    collect_common(
        terminal,
        runtime,
...
pub fn collect_doctor_tui<'a>(
    ...
    let is_wayland = crate::host::DisplayServer::current() == crate::host::DisplayServer::Wayland;
    let native_tool = intellihelper_shell::util::clipboard::native_tool_name();
    DoctorProbeSnapshot {
        ...
        container_no_display: intellihelper_shell::util::clipboard::is_containerized_without_display(),
...
fn collect_standalone_with_tmux<'a>(
    ...
    let container_no_display = intellihelper_shell::util::clipboard::is_containerized_without_display();
...
fn standalone_data_control(is_wayland: bool) -> TmuxProbeResult<bool> {
    ...
    match intellihelper_shell::util::clipboard::probe_wayland_data_control() {
        intellihelper_shell::util::clipboard::WaylandDataControlProbe::Available(value) => {
            TmuxProbeResult::Available(value)
        }
        intellihelper_shell::util::clipboard::WaylandDataControlProbe::Unavailable => {
            TmuxProbeResult::Unavailable
        }
        intellihelper_shell::util::clipboard::WaylandDataControlProbe::Error(error) => {
...
fn collect_common<'a>(
    ...
    let data_control =
        is_wayland && intellihelper_shell::util::clipboard::wayland_data_control_supported();
    ProbeSnapshot {
        terminal,
