...
impl SessionActor {
    ...
    pub(super) async fn register_memory_tools(
        &self,
        bridge: &intellihelper_tools::bridge::ToolBridge,
    ) -> Result<(), String> {
        ...
        bridge
            .register_mcp_tools(
                ...
                intellihelper_tools::implementations::memory::search_tool::MemorySearchImpl,
                None,
            )
            .await
        ...
        bridge
            .register_mcp_tools(
                ...
                intellihelper_tools::implementations::memory::get_tool::MemoryGetImpl,
                None,
            )
            .await
    ...
    pub(super) fn emit_memory_session_summary(
        ...
        intellihelper_telemetry::session_ctx::log_event(
            intellihelper_telemetry::memory_telemetry::MemorySessionSummary {
    ...
    async fn run_dream_model_call(&self, user_message: &str) -> Result<String, acp::Error> {
        ...
        let request = ConversationRequest {
            ...
            model: Some(model),
            x_intellihelper_conv_id: Some(format!("dream-{}", uuid::Uuid::new_v4())),
            x_intellihelper_req_id: Some(format!("xai-dream-{}", uuid::Uuid::new_v4())),
    ...
    pub(super) async fn run_memory_flush(
        ...
        tracing::info!(target: intellihelper_telemetry::memory_log::TARGET, "MEMORY_FLUSH: starting");
        ...
        let result = async {
            ...
            intellihelper_telemetry::session_ctx::log_event(
                intellihelper_telemetry::memory_telemetry::MemoryFlushStart {
                    session_id: self.session_info.id.to_string(),
            ...
            let request = ConversationRequest {
                items,
                model: Some(model),
                x_intellihelper_conv_id: Some(format!("flush-{}", uuid::Uuid::new_v4())),
                x_intellihelper_req_id: Some(format!("xai-flush-{}", uuid::Uuid::new_v4())),
                x_intellihelper_session_id: Some(session_id.clone()),
                x_intellihelper_agent_id: Some(intellihelper_telemetry::id::agent_id()),
                ..Default::default()
            };
        ...
        tracing::info!(target: intellihelper_telemetry::memory_log::TARGET, outcome = %outcome, "MEMORY_FLUSH: completed");
        ...
        intellihelper_telemetry::session_ctx::log_event(
            intellihelper_telemetry::memory_telemetry::MemoryFlushComplete {
                session_id: self.session_info.id.to_string(),
                trigger: trigger.to_owned(),
        ...
        let flush_trigger = match trigger {
            "slash_command" => intellihelper_telemetry::events::MemoryFlushTrigger::SlashCommand,
            "interval" => intellihelper_telemetry::events::MemoryFlushTrigger::Interval,
            "pre_compaction" => intellihelper_telemetry::events::MemoryFlushTrigger::PreCompaction,
            _ => intellihelper_telemetry::events::MemoryFlushTrigger::UserRequested,
        };
        intellihelper_telemetry::session_ctx::log_event(intellihelper_telemetry::events::MemoryFlushed {
    ...
    /// LLM call using the `intellihelper-build` model.
    ///
    ...
    pub(super) async fn handle_rewrite_memory_note(
        ...
        let request = ConversationRequest {
            items,
            tools: vec![],
            model: Some("intellihelper-build".to_owned()),
