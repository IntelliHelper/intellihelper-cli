...
//! cargo build --release -p intellihelper-shared --example clipboard_probe
//! hyperfine --warmup 2 \
//!   -n native './target/release/examples/clipboard_probe' \
//!   -n osascript 'INTELLIHELPER_CLIPBOARD_NO_NATIVE_READ=1 ./target/release/examples/clipboard_probe'
//! ```
//!
...
fn main() -> anyhow::Result<()> {
    ...
    let attachments = intellihelper_shared::clipboard::get_attachments()?;
