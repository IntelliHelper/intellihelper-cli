...
impl SessionRegistryClient {
    pub fn new(base_url: impl Into<String>, user_token: impl Into<String>) -> Self {
        ...
        Self {
            ...
            credentials: crate::util::intellihelper_auth_credentials::IntelliHelperAuthCredentials::new(Some(
                user_token.into(),
            )),
            session_id: None,
        }
    ...
    /// [`intellihelper_auth::StampedBearerSuffix`] for why never a re-resolution).
    fn record_401_attribution(&self, op: &str, stamp: Option<&intellihelper_auth::StampedBearerSuffix>) {
