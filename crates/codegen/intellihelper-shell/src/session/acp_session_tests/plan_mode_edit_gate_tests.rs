...
use super::support::*;
use super::*;
/// Build an actor whose toolset parses intellihelper `search_replace` plus the plan
...
async fn build_gate_actor() -> SessionActor {
    ...
    *actor.agent.borrow_mut() = test_agent_with_tools(vec![
        ...
        ToolConfig::from_id("IntelliHelperBuild:search_replace"),
...
async fn tool_result_text(actor: &SessionActor, call_id: &str) -> String {
    ...
    conv.iter()
        ...
        .find_map(|item| match item {
            intellihelper_sampling_types::ConversationItem::ToolResult(tr)
...
/// worst case) still rejects a intellihelper edit outside the plan file, without ever
