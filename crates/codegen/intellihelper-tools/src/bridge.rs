//! ToolBridge: adapter that wraps `intellihelper-tools`'s `ToolRegistry` and
...
impl ToolBridge {
    ...
    /// `Some("get_task_output")` for the intellihelper_build agent and `None` for
    ...
    pub async fn list_scheduled_tasks(
        &self,
    ) -> Vec<crate::implementations::intellihelper_build::scheduler::types::ScheduledTask> {
    ...
    pub async fn delete_scheduled_task(
        ...
        reply_rx
            ...
            .map_err(crate::implementations::intellihelper_build::scheduler::types::scheduler_tool_error)
    }
...
mod tests {
    ...
    fn tool_kind_returns_registered_kind_per_namespace_and_none_for_unknown() {
        ...
        // PascalCase + intellihelper_build's snake_case in one registry
