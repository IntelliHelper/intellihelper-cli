...
Terminal UI (TUI) for IntelliHelper CLI. Provides the interactive full-screen interface
...
- [Hook Examples](../intellihelper-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`intellihelper-hooks`)](../intellihelper-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`intellihelper-plugin-marketplace`)](../intellihelper-plugin-marketplace/) — marketplace source loading, scanning, and install
