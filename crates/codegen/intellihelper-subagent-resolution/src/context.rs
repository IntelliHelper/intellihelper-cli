...
//!
//! Extracted from `intellihelper-shell/src/agent/subagent/` `normalize_forked_context()`.
...
/// `intellihelper-shell/src/session/storage/jsonl.rs` (it truncates to the last
...
mod tests {
    use super::*;
    use intellihelper_sampling_types::conversation::{ConversationItem, ToolCall, ToolResultItem};
    ...
    fn reasoning_item(text: &str) -> ConversationItem {
        ConversationItem::Reasoning(intellihelper_sampling_types::synthesized_reasoning_item(text))
    }
