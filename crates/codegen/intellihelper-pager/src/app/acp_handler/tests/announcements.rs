#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// layer-injected seam so the developer's real `~/.intellihelper` cannot leak in.
    #[test]
    ...
    /// through the layer-injected seam (no real `~/.intellihelper` reads).
    #[test]
    ...
    /// layer-injected seam (no real `~/.intellihelper` reads).
    #[test]
