...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* intellihelper_home (where this hydrated copy lives),
            // not the original remote session's, since reconstruction runs locally.
            intellihelper_home: crate::session::persistence::intellihelper_home_string(),
            last_active_at: None,
            ...
            sandbox_profile: intellihelper_sandbox::configured_profile_name().map(String::from),
