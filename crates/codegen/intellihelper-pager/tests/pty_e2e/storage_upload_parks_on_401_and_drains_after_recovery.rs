...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    let overrides = [
        ...
        EnvOp::set("INTELLIHELPER_TRACE_UPLOAD", "true"),
        EnvOp::set("INTELLIHELPER_TELEMETRY_TRACE_UPLOAD", "true"),
        EnvOp::set("INTELLIHELPER_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"),
    ];
    ...
    //
    // Accounting (file-utils upload queue):
    ...
    //   not fire inside this 3s window; with `INTELLIHELPER_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
