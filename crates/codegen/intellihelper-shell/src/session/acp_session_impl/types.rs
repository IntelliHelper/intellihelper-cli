...
pub(crate) enum SamplerFailureRecovery {
    ...
    RefreshAuthAndResubmit {
        credential: intellihelper_sampling_types::SentCredential,
...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<intellihelper_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(intellihelper_tools::implementations::intellihelper_build::update_goal::UpdateGoalInput),
    Channel(intellihelper_tools::implementations::intellihelper_build::update_goal::UpdateGoalEnvelope),
}
