...
//!   under `~/.intellihelper/worktree_pool/<instance_id>/` with a `.pid` liveness
...
/// `~/.intellihelper/worktree_pool/<instance_id>/` with a `.pid` file recording
...
impl WorktreePool {
    ...
    /// `~/.intellihelper/worktree_pool/<instance_id>/`. A `.pid` file is written so
...
pub struct AdoptableWorktree {
    /// Current path: `~/.intellihelper/worktree_pool/<old_instance>/<pool_id>/`
...
/// `~/.intellihelper/worktree_pool/`, reads each `.pid` file, and checks
...
/// The base pool directory under `~/.intellihelper/`.
...
/// `CleanAll` mode. Placed under `~/.intellihelper/worktree_pool/<instance_id>/<uuid>/`.
