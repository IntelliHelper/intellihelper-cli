...
//!
//! Run with:
//!   cargo run -p intellihelper-markdown --features playground --bin md-table-test
//!
//! Controls:
...
// ── Tokyo Night Storm palette (matches intellihelper-pager) ──────────────────────
