use intellihelper_telemetry::events::SessionHarness;
use intellihelper_workspace::permission::Decision;
...
pub(crate) fn skill_source_label(skill_path: &str, cwd: &str) -> &'static str {
    ...
    let user = crate::util::intellihelper_home::intellihelper_home()
        .parent()
...
pub(crate) fn format_hook_name(spec: &intellihelper_hooks::config::HookSpec) -> String {
...
fn format_hook_source(spec: &intellihelper_hooks::config::HookSpec) -> &'static str {
    use intellihelper_hooks::config::HookOrigin as O;
    match intellihelper_hooks::config::hook_origin(spec) {
...
impl HookRegInfo {
    pub(crate) fn from_spec(spec: &intellihelper_hooks::config::HookSpec) -> Self {
        Self {
...
pub(crate) struct SessionHarnessMetrics {
    ...
    pub permission_mode: intellihelper_telemetry::enums::PermissionMode,
    ...
    pub compat: intellihelper_tools::types::compat::CompatConfig,
...
impl SessionHarnessMetrics {
    pub(crate) async fn into_event(self, hooks: Vec<HookRegInfo>) -> SessionHarness {
        ...
        let agents_md_dir_names = intellihelper_agent::prompt::agents_md::read_agents_config_with_paths(
            &self.cwd,
            self.compat,
        )
        .await
        ...
        SessionHarness {
            ...
            is_git_repo: intellihelper_telemetry::context::collect_git_context(&self.cwd).is_git_repo,
...
mod is_same_skill_file_tests {
    ...
    fn matches_identical_paths() {
        assert!(is_same_skill_file(
            Path::new("/home/u/.intellihelper/skills/review/SKILL.md"),
            Path::new("/home/u/.intellihelper/skills/review/SKILL.md")
        ));
    }
    ...
    fn rejects_a_different_skill() {
        assert!(!is_same_skill_file(
            Path::new("/home/u/.intellihelper/skills/review/SKILL.md"),
            Path::new("/home/u/.intellihelper/skills/design/SKILL.md")
        ));
    }
