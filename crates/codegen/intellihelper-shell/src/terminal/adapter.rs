//! `AcpTerminalAdapter`: implements `intellihelper-tools::TerminalBackend` over ACP
...
use intellihelper_tools::computer::types::{
...
/// Wraps intellihelper-shell's ACP gateway to satisfy intellihelper-tools' TerminalBackend.
