...
Want IntelliHelper working on a feature while you (or another IntelliHelper session) work on
...
- **From the shell:**
  ...
  ```bash
  intellihelper --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three IntelliHelper sessions on the same repo simultaneously.
