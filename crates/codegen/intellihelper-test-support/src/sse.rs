...
//!
//! These produce the exact wire format that the intellihelper sampling client expects,
...
/// event (`intellihelper_sampling_types::DOOM_LOOP_CHECK_EVENT_TYPE`). Hardcoded
