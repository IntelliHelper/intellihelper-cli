...
//!
//! ```bash
//! LEADER_SOAK_SECS=1200 cargo test -p intellihelper-shell --features test-support \
...
use intellihelper_test_support::resources::ResourceSnapshot;
...
async fn leader_soak_churning_clients_no_leaks_no_zombies() {
    ...
    let sock_path = intellihelper_home.path().join("leader-soak.sock");
    ...
    local
        .run_until(async {
            ...
            intellihelper_shell::leader::in_process::spawn_agent(acp_rx, response_tx.clone());
