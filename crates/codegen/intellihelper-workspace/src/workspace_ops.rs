...
use intellihelper_tools::types::output::ToolRunResult;
use intellihelper_workspace_client::{WorkspaceClient, is_transport_fatal};
pub use intellihelper_workspace_types::rpc::WorkspaceRpc;
pub use intellihelper_workspace_types::rpc::agents_md::DiscoverAgentsMdReq;
pub use intellihelper_workspace_types::rpc::code_nav::{
...
pub use intellihelper_workspace_types::rpc::export_github::ExportGithubReq;
pub use intellihelper_workspace_types::rpc::fs::{
...
pub use intellihelper_workspace_types::rpc::git::{
...
pub use intellihelper_workspace_types::rpc::hooks::{
    HookEventNameWire, HookRegistryReq, HookRegistryWire, HookSpecWire,
};
pub use intellihelper_workspace_types::rpc::hunks::{
...
pub use intellihelper_workspace_types::rpc::search::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
pub use intellihelper_workspace_types::rpc::session::{BeginPromptReq, EndPromptReq, RewindToReq};
pub use intellihelper_workspace_types::rpc::skills::DiscoverSkillsReq;
pub use intellihelper_workspace_types::rpc::workspace::WorkspaceInfoReq;
...
fn hook_registry_to_wire(
    registry: &intellihelper_hooks::discovery::HookRegistry,
...
fn wire_to_hook_registry(
...
) -> WorkspaceResult<intellihelper_hooks::discovery::HookRegistry> {
    ...
    let mut registry: intellihelper_hooks::discovery::HookRegistry =
        serde_json::from_value(value).map_err(|e| WorkspaceError::HubError(e.to_string()))?;
...
///   session's [`FinalizedToolset`](intellihelper_tools::registry::types::FinalizedToolset).
...
impl WorkspaceOps {
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<intellihelper_hooks::discovery::HookRegistry> {
    ...
    ///   [`FinalizedToolset`](intellihelper_tools::registry::types::FinalizedToolset)
...
mod tests {
    ...
    /// request types are defined in `intellihelper-workspace-types` (and re-exported
    ...
    async fn end_local_session_drops_bound_toolset() {
        ...
        let toolset = std::sync::Arc::new(
            intellihelper_tools::registry::types::FinalizedToolset::empty_for_test(),
        );
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = intellihelper_hooks::config::HookSpec {
            ...
            event: intellihelper_hooks::event::HookEventName::PreToolUse,
            ...
            url_raw: None,
            timeout_ms: 5000,
            source_dir: std::path::PathBuf::from("/home/u/.intellihelper/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
            layer: intellihelper_hooks::config::HookProvenance::File,
        };
        let mut registry = intellihelper_hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use intellihelper_hooks::event::HookEventName as E;
    ...
    /// can't depend on `intellihelper-hooks`, and `hook_registry_to_wire` only couples
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        use intellihelper_hooks::config::HookSpec;
        ...
        let spec = HookSpec {
            ...
            source_dir: std::path::PathBuf::from("/home/u/.intellihelper/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
            layer: intellihelper_hooks::config::HookProvenance::Managed,
        };
        assert_eq!(
