...
use intellihelper_sampler::{SamplerConfig, SamplingClient};
...
<html lang="en-US">
<head><title>intellihelper.com | 522: Connection timed out</title></head>
<body>
...
async fn stream_err(status: u16, body: &str) -> intellihelper_sampling_types::SamplingError {
