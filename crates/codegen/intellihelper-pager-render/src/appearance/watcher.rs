...
//!
//! In dev mode, watches ~/.intellihelper/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.intellihelper/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.intellihelper/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = intellihelper_config::user_intellihelper_home()
