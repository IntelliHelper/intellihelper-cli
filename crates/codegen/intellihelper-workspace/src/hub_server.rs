...
use intellihelper_tools::implementations::intellihelper_build::scheduler::interval::interval_to_human;
use intellihelper_tools::implementations::intellihelper_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use intellihelper_tools::registry::types::FinalizedToolset;
use intellihelper_tools::types::resources::Terminal;
use intellihelper_workspace_types::rpc::workspace::{
...
static WORKSPACE_RPC_CALLER_MISMATCH_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "intellihelper_workspace_rpc_caller_mismatch_total",
...
static WORKSPACE_RPC_MUTATION_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "intellihelper_workspace_rpc_mutation_total",
...
static WORKSPACE_RPC_REQUESTS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "intellihelper_workspace_rpc_requests_total",
...
static WORKSPACE_RPC_ERRORS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "intellihelper_workspace_rpc_errors_total",
...
static WORKSPACE_RPC_DURATION_SECONDS: std::sync::LazyLock<HistogramVec> =
    std::sync::LazyLock::new(|| {
        register_histogram_vec!(
            "intellihelper_workspace_rpc_duration_seconds",
...
) -> Vec<intellihelper_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use intellihelper_tools::computer::types::TaskKind;
    use intellihelper_tools::types::resources::Terminal;
    use intellihelper_tools::types::tool::ToolKind;
    use intellihelper_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &intellihelper_tools::registry::types::FinalizedToolset,
) -> Vec<intellihelper_workspace_types::rpc::workspace::TodoSummaryWire> {
    use intellihelper_tools::implementations::intellihelper_build::todo::{TodoState, TodoStatus};
    use intellihelper_tools::types::resources::State;
    use intellihelper_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use intellihelper_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use intellihelper_workspace_types::rpc::search::FuzzyStatusReq;
        use intellihelper_workspace_types::rpc::skills::DiscoverPluginsReq;
        use intellihelper_workspace_types::rpc::workspace::{
        ...
        use intellihelper_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
...
mod tests {
    ...
    async fn handle_hook_request_turn_hook_returns_reply() {
        ...
        let req = turn_hook::TurnHookRequest::Before(turn_hook::BeforeTurnPayload {
            turn_number: 1,
            model_id: "intellihelper-3".to_owned(),
            yolo_mode: false,
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use intellihelper_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                ...
                Some(intellihelper_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn handle_call_records_rpc_metrics_and_collapses_unknown_method() {
        ...
        let has_bogus_series = prometheus::gather()
            .iter()
            .filter(|mf| mf.name() == "intellihelper_workspace_rpc_requests_total")
