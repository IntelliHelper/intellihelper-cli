...
// Re-export the shared IntelliHelperIntegerSchema from types module
pub use crate::types::IntelliHelperIntegerSchema;
use ripgrep::rg_path;
...
crate::register_resource!("intellihelper_build", "Grep", GrepParams);
