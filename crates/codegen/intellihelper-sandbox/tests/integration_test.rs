//! Integration tests for intellihelper-sandbox.
//!
...
fn test_profile_capability_set_construction() {
    use intellihelper_sandbox::ProfileName;
...
fn test_sandbox_logger() {
    use intellihelper_sandbox::{SandboxEvent, SandboxLogger};
...
fn test_should_restrict_child_network_default() {
    ...
    assert!(!intellihelper_sandbox::should_restrict_child_network());
}
