...
//!
//! ```text
//! cargo bench -p intellihelper-pager --bench edit_highlight
//! cargo bench -p intellihelper-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use intellihelper_pager::diff::{DiffHunk, DiffLine};
use intellihelper_pager::scrollback::blocks::tool::{
...
use intellihelper_pager::syntax::{Syntect, get_syntect};
