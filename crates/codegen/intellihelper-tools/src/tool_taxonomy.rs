...
///   share it (intellihelper `read_file` → `"Read"`).
...
mod tests {
    ...
    fn identity(kind: ToolKind) -> ToolIdentity {
        ToolIdentity {
            tool_kind: kind,
            namespace: ToolNamespace::IntelliHelperBuild,
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::IntelliHelperBuild => ("intellihelper_build", "IntelliHelperBuild"),
                ToolNamespace::IntelliHelperBuildConcise => ("intellihelper_build_concise", "IntelliHelperBuildConcise"),
                ToolNamespace::IntelliHelperBuildHashline => ("intellihelper_build_hashline", "IntelliHelperBuildHashline"),
