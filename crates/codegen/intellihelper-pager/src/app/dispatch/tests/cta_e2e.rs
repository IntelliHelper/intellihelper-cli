...
mod cta_e2e {
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = intellihelper_shell::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        intellihelper_shell::config::add_dismissed_plugin_cta_to_file("figma", &config_path)
