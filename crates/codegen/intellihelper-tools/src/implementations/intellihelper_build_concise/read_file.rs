...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::IntelliHelperBuildConcise
    }
...
impl tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // IntelliHelperBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::intellihelper_build::read_file::ReadFileTool;
