...
IntelliHelper knows its own capabilities and can configure itself. Try:
...
## Teach IntelliHelper your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. IntelliHelper reads it automatically in every session — it's the single
...
## Teach IntelliHelper your facts: memory
