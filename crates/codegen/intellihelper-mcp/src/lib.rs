...
//!    `mixpanel`, `intellihelper-tools`, ...) also pinned to 0.12. Bumping every
...
//!    (`intellihelper_mcp::rmcp::*`).
//!
//! 2. **Owns MCP-specific integration code**:
//!    - [`credentials`] -- on-disk `$INTELLIHELPER_HOME/mcp_credentials.json` store and
