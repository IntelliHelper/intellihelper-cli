...
//!
//! This crate stays decoupled from `intellihelper-shell`: no shell types, no
//! auth-manager dependency.

use std::sync::Arc;

pub use intellihelper_auth::bearer_fragment::BEARER_SUFFIX_LEN;
...
/// Sampler endpoints only — tool clients use `intellihelper_tools::ToolConsumer`.
