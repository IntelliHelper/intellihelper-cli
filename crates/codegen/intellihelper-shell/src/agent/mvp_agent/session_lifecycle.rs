...
impl MvpAgent {
    ...
    pub(crate) fn remove_session(&self, id: &acp::SessionId) {
        let _ = self
            .subagent_event_tx
            .send(intellihelper_tools::implementations::intellihelper_build::task::types::SubagentEvent::TeardownSession {
        ...
        self.log_resource_usage(intellihelper_telemetry::events::ResourceReportTrigger::SessionClose);
    }
