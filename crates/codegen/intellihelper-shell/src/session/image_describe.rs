...
//! content blocks, the session calls a vision-capable IntelliHelper model
...
use intellihelper_tools::util::truncate::truncate_middle;
...
impl ImageDescribeCache {
    ...
    pub(crate) async fn get_or_describe(
        &self,
        client: intellihelper_sampler::SamplingClient,
        model: &str,
        raw_bytes: &[u8],
        mime_type: &str,
        outline: Option<&str>,
...
mod tests {
    use super::*;
    use intellihelper_sampling_types::conversation::{ConversationItem, UserItem};
    #[test]
    ...
    fn user(text: &str) -> ConversationItem {
        ConversationItem::User(UserItem {
            content: vec![intellihelper_sampling_types::conversation::ContentPart::Text {
                text: text.into(),
            }],
            synthetic_reason: None,
            ..Default::default()
