...
use intellihelper_shell::extensions::notification::GoalClassifierVerdict;
...
impl BgTaskState {
    ...
    pub fn tombstone_from_snapshot(
        snapshot: &intellihelper_tools::types::TaskSnapshot,
        status: BgTaskStatus,
...
impl AgentSession {
    ...
    /// [`intellihelper_prompt_queue::combine_prefix_len`]. `editing_id` is held out of the
    ...
    pub fn dequeue_combined_prompt(&mut self, editing_id: Option<u64>) -> Option<QueuedPrompt> {
        use intellihelper_prompt_queue::{CombineGate, TEXT_SEPARATOR, combine_prefix_len, join_texts};
