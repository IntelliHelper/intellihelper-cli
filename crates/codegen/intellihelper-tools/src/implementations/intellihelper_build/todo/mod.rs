...
crate::register_resource!("intellihelper_build", "Todo", TodoState);
...
mod tests {
    ...
    async fn state_serialization_roundtrip() {
        ...
        assert!(
            state_map.get("intellihelper_build.Todo").is_some(),
            "TodoState should serialize under 'intellihelper_build.Todo'"
        );
