//! IntelliHelperNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// IntelliHelperNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_intellihelpernight_theme() {
