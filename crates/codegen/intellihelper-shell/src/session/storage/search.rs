...
//! other concurrently running intellihelper processes (which may wipe or downgrade
...
///
/// TODO: When multiple intellihelper processes run concurrently, they each have
