//! `IntelliHelperBuildConcise` namespace — concise variants of core IntelliHelperBuild tools.
//!
//! These tools share implementation with `intellihelper_build` via `pub(crate)` helpers
