...
pub enum ActionId {
    ...
    // Prompt
    EditPromptExternal,
    /// Rewrite the composer draft in place (does not send).
    OptimizeInput,
    UndoOptimizeInput,
    CycleMode,
    BashMode,
...
/// Emit [`intellihelper_telemetry::events::ShortcutUsed`] for an allowlisted binding.
///
...
pub fn log_shortcut_used(key: &KeyEvent, action_id: ActionId, context: &str) {
    ...
    intellihelper_telemetry::session_ctx::log_event(intellihelper_telemetry::events::ShortcutUsed {
