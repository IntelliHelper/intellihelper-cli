# IntelliHelper CLI User Guide

Learn how to install, configure, and extend IntelliHelper CLI, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend IntelliHelper CLI.
...
Automate, script, and integrate IntelliHelper CLI with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `intellihelper -p`, output formats, CI/CD integration, and piping |
