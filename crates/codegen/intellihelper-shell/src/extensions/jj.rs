//! Jujutsu extension handlers — delegates to [`intellihelper_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use intellihelper_workspace::session::git::{CommitData, StageData};
use intellihelper_workspace::session::jj;
