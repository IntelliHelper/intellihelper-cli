...
Fear not — your settings, rules, and skills come with you. IntelliHelper CLI
...
writes the items you selected into your `.intellihelper` config. Re-run it anytime.
...
Run **`intellihelper inspect`** in a repo to see every rules file, skill, and MCP
server IntelliHelper picked up, tagged with where it came from. Each compat source
