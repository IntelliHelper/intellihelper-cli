...
pub mod intellihelper_build;
pub mod intellihelper_build_concise;
pub mod intellihelper_build_hashline;
pub mod lsp;
pub mod memory;
pub mod opencode;
pub mod read_file;
...
pub mod use_tool;
pub mod web_search;
pub use intellihelper_build::bash::{BashError, BashToolInput};
pub use intellihelper_build::{
