...
impl crate::types::tool_metadata::ToolMetadata for HashlineEditTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::IntelliHelperBuildHashline
    }
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::intellihelper_build_hashline::anchor::split_lines;
        use crate::implementations::intellihelper_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::intellihelper_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    fn test_scheme() -> Box<dyn crate::implementations::intellihelper_build_hashline::scheme::AnchorScheme> {
        crate::implementations::intellihelper_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
