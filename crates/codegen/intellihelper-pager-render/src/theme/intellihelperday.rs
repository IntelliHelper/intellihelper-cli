//! IntelliHelperDay theme — neutral gray base (light) with deepened accent colors.
//!
//! Light counterpart to IntelliHelperNight. Backgrounds and text use a neutral
//! grayscale ramp (no blue/warm tint). Accent colors are the same hue
//! family as IntelliHelperNight but deepened for contrast on light backgrounds.
...
impl Theme {
    pub const fn intellihelperday() -> Self {
        Self {
            bg_base: BG_STORM,
