...
impl<'a> SkillEntry<'a> {
    ...
    // ── Budgeted XML rendering (intellihelper build harness) ─────────────
...
///
/// `"/path/.intellihelper/skills/my-skill/SKILL.md"` -> `"/path/.intellihelper/skills/"`
...
/// Used by the budgeted (intellihelper build) XML rendering path.
...
pub enum XmlRenderMode {
    ...
    Verbatim,
    /// IntelliHelper build harness: budget-capped three-tier rendering with full
    /// XML entity escaping.
    Budgeted {
        ...
        skills
            ...
            .filter(|s| {
                s.enabled
                    ...
                    // Compat mode renders all skills verbatim; only the intellihelper
...
mod tests {
    ...
    fn verbatim_bypasses_is_listable_filter() {
        // intellihelper-build drops a description-less skill; compat mode renders all.
    ...
    // ── budgeted mode: intellihelper build harness (budgeted XML) ───────────
