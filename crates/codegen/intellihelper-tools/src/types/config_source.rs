...
pub enum ConfigSource {
    ...
    Builtin,
    /// Bundled skill shipped with the binary (extracted to ~/.intellihelper/skills/
    /// or injected via bundled skill dirs).
    Bundled { path: PathBuf },
    /// Server-synced (e.g. ~/.intellihelper/server-skills from the skill store).
    Server { path: PathBuf },
    /// Project-scoped: cwd/.intellihelper/ or cwd/.claude/.
    Project { path: PathBuf },
    /// User-scoped: ~/.intellihelper/ or ~/.claude/.
    User { path: PathBuf },
