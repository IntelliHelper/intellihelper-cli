...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "intellihelper-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "intellihelper-3", "researcher");
    ...
    let shared_models = ["intellihelper-3", "intellihelper-3-mini"];
