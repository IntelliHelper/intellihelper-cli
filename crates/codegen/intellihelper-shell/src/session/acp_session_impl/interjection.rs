...
// interjection-core crate so the server-side agent loop can adopt the
...
pub(crate) use interjection_core::{InterjectionBuffer, drain_formatted, format_interjection};
