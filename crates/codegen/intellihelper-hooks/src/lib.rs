//! # intellihelper-hooks
//!
//! Runtime hook system for IntelliHelper — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for IntelliHelper. Hooks are discovered
//! from dedicated directories (`~/.intellihelper/hooks/` and `<git-worktree-root>/.intellihelper/hooks/`),
...
//!     Some(Path::new("/home/user/.intellihelper/hooks")),
//!     Some(Path::new("/project/.intellihelper/hooks")),
//! );
//!
//! for err in &errors {
