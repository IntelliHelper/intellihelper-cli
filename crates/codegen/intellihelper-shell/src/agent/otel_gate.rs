...
//! [`intellihelper_telemetry::external`]:
//!
...
pub(crate) fn suppress() {
    intellihelper_telemetry::external::set_settings_gate_max_wait(SETTINGS_GATE_MAX_WAIT);
...
/// Returns whether a session-less startup is about to mint a intellihelper.com session
