...
use intellihelper_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (intellihelper_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    intellihelper_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use intellihelper_shell::tools::{TodoItem, TodoPriority};
