...
//! `intellihelper_sampling_types` plus intellihelper-shell-specific additions.

use std::collections::HashSet;

pub use intellihelper_sampling_types::conversation::*;
...
/// through its blanket impl. Lives in intellihelper-shell because it references
...
/// `count_complete_turns` in `intellihelper-subagent-resolution/src/context.rs`.
