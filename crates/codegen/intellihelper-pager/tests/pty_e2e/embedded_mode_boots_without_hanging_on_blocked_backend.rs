...
/// backend, often with the intellihelper.com proxy blocked. A TCP listener that accepts
...
async fn embedded_mode_boots_without_hanging_on_blocked_backend() {
    ...
    let env = [
        ...
        ("INTELLIHELPER_HOME", intellihelper_home.to_str().unwrap()),
        ("XAI_API_KEY", "test-key-for-ci"),
        ("INTELLIHELPER_CLI_CHAT_PROXY_BASE_URL", base.as_str()),
        ("INTELLIHELPER_XAI_API_BASE_URL", base.as_str()),
