...
///
/// Use with `#[schemars(with = "IntelliHelperIntegerSchema")]` on `Option<usize>` fields.
pub struct IntelliHelperIntegerSchema;
impl schemars::JsonSchema for IntelliHelperIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "intellihelper_integer_schema".into()
    }
