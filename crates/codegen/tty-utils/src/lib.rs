...
/// killed intellihelper and pile up on shared hosts. No-op on non-Linux platforms
...
/// the agent SDKs, `intellihelper-desktop` all spawn `intellihelper agent … stdio`): the
