...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(intellihelper_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-intellihelper-test"),
        ...
        parent_skills: None,
        parent_skills_config: intellihelper_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: intellihelper_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: intellihelper_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl intellihelper_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &intellihelper_tools::implementations::lsp::LspToolInput,
    ) -> intellihelper_tools::implementations::lsp::LspToolResult {
        intellihelper_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<intellihelper_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<intellihelper_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
