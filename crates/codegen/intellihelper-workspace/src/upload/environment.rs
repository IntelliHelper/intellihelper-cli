...
impl WorkspaceIdentity {
    ...
    /// `IntelliHelperAuth.team_id`, and for a Team principal `principal_id` *is* the
    /// team id.
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `intellihelper-workspace` crate that produced the record.
    ...
    /// Sandbox profile name (`$INTELLIHELPER_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("INTELLIHELPER_SANDBOX_PROFILE").ok(),
