...
use crate::implementations::intellihelper_build::task::TaskTool;
use crate::implementations::intellihelper_build::task::backend::SubagentBackendResource;
use crate::implementations::intellihelper_build::task::types::{SubagentSnapshot, SubagentSnapshotStatus};
use crate::implementations::intellihelper_build_concise::BashConciseTool;
...
/// The blocking-wait ceiling: `INTELLIHELPER_MAX_WAIT_BLOCK_MS`, else 10 min.
///
...
pub(crate) fn background_bash_requires_exprs() -> Vec<Expr<ToolRequirement>> {
    ...
    let intellihelper_build_bash = Expr::Value(ToolRequirement::Tool {
    ...
    let intellihelper_build_concise_bash = Expr::Value(ToolRequirement::Tool {
    ...
    vec![intellihelper_build_bash, intellihelper_build_concise_bash, opencode_bash]
}
...
impl crate::types::tool_metadata::ToolMetadata for TaskOutputTool {
    ...
    fn description_template(&self) -> &str {
        ...
        // fallback mirrors the default intellihelper-build toolset.
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        // The static fallback is the shared builder's default intellihelper-build
    ...
    fn resources_with_backend_query() -> (
        ...
        tokio::sync::mpsc::UnboundedReceiver<
            crate::implementations::intellihelper_build::task::types::SubagentEvent,
        >,
    ) {
        use crate::implementations::intellihelper_build::task::backend::{
            ChannelBackend, SubagentBackendResource,
        };
        use crate::implementations::intellihelper_build::task::types::SubagentEvent;
    ...
    fn unwrap_query(
        event: crate::implementations::intellihelper_build::task::types::SubagentEvent,
    ) -> crate::implementations::intellihelper_build::task::types::SubagentQueryRequest {
        match event {
            crate::implementations::intellihelper_build::task::types::SubagentEvent::Query(q) => q,
