...
/// Claude.md / `.intellihelper/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.intellihelper` and compat dirs.
...
/// Mirrors the serde shape of `intellihelper-agent`'s `AgentConfigFile`.
