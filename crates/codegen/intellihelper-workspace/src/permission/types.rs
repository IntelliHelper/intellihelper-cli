...
pub enum ClientType {
    ...
    #[default]
    #[serde(rename = "generic", alias = "intellihelper-shell", alias = "intellihelper_shell")]
    Generic,
    /// IntelliHelper TUI client - show fancy options with interactive bash term selection
    #[serde(rename = "intellihelper-tui", alias = "intellihelper_tui")]
    IntelliHelperTUI,
    /// IntelliHelper Web client - identified by clientIdentifier "intellihelper-web"
    #[serde(rename = "intellihelper_web")]
    IntelliHelperWeb,
    /// Named client (`"nebula"`) — uses the generic permission UI
    #[serde(rename = "nebula")]
    Nebula,
    /// IDE extension client (VS Code and similar) - identified by clientIdentifier "intellihelper-code-extension"
    #[serde(rename = "extension")]
    Extension,
    /// IntelliHelper Pager client - TUI-like terminal pager with interactive permission UI.
    /// Treated identically to IntelliHelperTUI for permission options (gets bash highlights +
    /// interactive selection). Reports as "pager" for telemetry attribution.
    ///
    /// Accepts both the hyphenated `"intellihelper-pager"` (what the pager actually
    /// sends over the wire, matching `PAGER_CLIENT_TYPE`) and the underscored
    /// `"intellihelper_pager"` form for symmetry with the rest of this enum.
    #[serde(rename = "intellihelper-pager", alias = "intellihelper_pager")]
    IntelliHelperPager,
    /// IntelliHelper Desktop (Electron) client - identified by clientIdentifier "intellihelper-desktop".
    /// Uses TUI-style bash permission options (primary command extraction + prefix matching)
    /// but without interactive `<`/`>` word selection.
    #[serde(rename = "intellihelper_desktop")]
    Desktop,
}
impl ClientType {
    /// Product token for the `User-Agent` header (e.g. `intellihelper-pager`).
    pub fn user_agent_label(&self) -> &'static str {
        match self {
            Self::Generic => "intellihelper-shell",
            Self::IntelliHelperTUI => "intellihelper-tui",
            Self::IntelliHelperWeb => "intellihelper-web",
            Self::Nebula => "nebula",
            Self::Extension => "intellihelper-code-extension",
            Self::IntelliHelperPager => "intellihelper-pager",
            Self::Desktop => "intellihelper-desktop",
        }
    }
    /// Resolve from ACP `clientIdentifier` string (e.g. `"intellihelper-web"`, `"intellihelper-desktop"`).
    pub fn from_client_identifier(id: Option<&str>) -> Self {
        match id {
            Some("intellihelper-web") => Self::IntelliHelperWeb,
            Some("nebula") => Self::Nebula,
            Some("intellihelper-code-extension") => Self::Extension,
            Some("intellihelper-desktop") => Self::Desktop,
            Some("intellihelper-pager") => Self::IntelliHelperPager,
            _ => Self::Generic,
        }
    }
    ...
    pub fn feedback_label(&self) -> &'static str {
        match self {
            Self::IntelliHelperTUI | Self::IntelliHelperPager => "tui",
            Self::IntelliHelperWeb => "web",
            Self::Nebula => "nebula",
...
impl From<&intellihelper_tools::types::ToolInput> for AccessKind {
    fn from(input: &intellihelper_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.intellihelper/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use intellihelper_tools::implementations::intellihelper_build_hashline::edit::types::HashlineEditInput;
        use intellihelper_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use intellihelper_tools::implementations::intellihelper_build::bash::BashToolInput;
        use intellihelper_tools::types::ToolInput;
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use intellihelper_tools::implementations::use_tool::UseToolInput;
        use intellihelper_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use intellihelper_tools::implementations::intellihelper_build::monitor::types::MonitorInput;
        use intellihelper_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use intellihelper_tools::implementations::intellihelper_build::web_fetch::WebFetchInput;
        use intellihelper_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use intellihelper_tools::implementations::intellihelper_build::web_search::WebSearchInput;
        use intellihelper_tools::types::ToolInput;
    ...
    #[test]
    fn client_type_deserializes_intellihelper_shell_as_generic() {
        assert_eq!(
            serde_json::from_value::<ClientType>("intellihelper-shell".into()).unwrap(),
            ClientType::Generic,
        );
        assert_eq!(
            serde_json::from_value::<ClientType>("intellihelper_shell".into()).unwrap(),
            ClientType::Generic,
        );
        assert_eq!(
