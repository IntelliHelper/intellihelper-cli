//! Shared helpers for intellihelper-shell integration tests.

use intellihelper_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use intellihelper_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `intellihelper_sampler::SamplingClient`, which takes a
