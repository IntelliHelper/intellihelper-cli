...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "INTELLIHELPER_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "INTELLIHELPER_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`INTELLIHELPER_MIN_DRAW_MS` / `INTELLIHELPER_SCROLL_CADENCE_MS`).
