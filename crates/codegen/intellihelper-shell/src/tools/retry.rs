//! Retry utilities — re-exported from `intellihelper-tools`.
//!
//! The canonical implementation now lives in `intellihelper_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use intellihelper_tools::retry::BackoffConfig as RetryConfig;
pub use intellihelper_tools::retry::{BackoffConfig, execute_with_backoff};
