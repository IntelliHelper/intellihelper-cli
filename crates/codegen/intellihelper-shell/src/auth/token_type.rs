...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&IntelliHelperAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> intellihelper_telemetry::events::AuthTokenKind {
        use intellihelper_telemetry::events::AuthTokenKind as K;
        match self {
