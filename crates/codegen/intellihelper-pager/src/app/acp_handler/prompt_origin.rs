...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    intellihelper_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        intellihelper_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        intellihelper_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        intellihelper_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        intellihelper_shell::session::PromptOrigin::TaskCompleted { .. }
            | intellihelper_shell::session::PromptOrigin::SubagentCompleted { .. }
            | intellihelper_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | intellihelper_shell::session::PromptOrigin::NotificationDrain
    )
}
