//! MCP server configuration value types, extracted from intellihelper-shell
...
use intellihelper_mcp::oauth_config::McpOAuthConfig;
...
/// and surfaced through `intellihelper inspect`.
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("INTELLIHELPER_RELAY_SYNC_ENABLED") {
