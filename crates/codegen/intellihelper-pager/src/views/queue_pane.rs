...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. IntelliHelperNight's dark band leaking into IntelliHelperDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default IntelliHelperNight, dark) after the user switches —
        // painting a dark band on a light IntelliHelperDay canvas.
