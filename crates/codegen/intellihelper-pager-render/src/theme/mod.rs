...
//! The default theme is IntelliHelperNight (neutral gray base with TokyoNight accents).
//!
//! ## Color support
//!
//! IntelliHelperNight is defined in `Color::Rgb` (truecolor). At startup,
...
mod intellihelperday;
mod intellihelpernight;
pub mod md_style;
pub mod osc11;
mod oscura;
mod rosepine;
...
impl ThemeKind {
    ...
    pub fn available() -> &'static [ThemeKind] {
        ...
        const NO_TRUECOLOR: &[ThemeKind] = &[ThemeKind::IntelliHelperNight, ThemeKind::IntelliHelperDay];
    ...
    pub fn display_name(self) -> &'static str {
        match self {
            Self::IntelliHelperNight => "intellihelpernight",
            Self::TokyoNight => "tokyonight",
            Self::IntelliHelperDay => "intellihelperday",
    ...
    /// when quantized to 256 or 16 colors. IntelliHelperNight uses neutral grays
    /// that survive quantization cleanly.
    pub fn requires_truecolor(self) -> bool {
        match self {
            Self::IntelliHelperNight => false,
            Self::TokyoNight => true,
            Self::IntelliHelperDay => false,
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        ...
        match lower.as_str() {
            ...
            "intellihelpernight" | "intellihelper-night" | "dark" => Some(Self::IntelliHelperNight),
            "tokyonight" | "tokyo-night" | "tokyo" => Some(Self::TokyoNight),
            "intellihelperday" | "intellihelper-day" | "light" | "day" => Some(Self::IntelliHelperDay),
...
/// `"intellihelpernight"` → `"IntelliHelper Night"`). Falls back to `value` verbatim.
pub fn display_name_for_canonical(value: &str) -> &str {
    match value {
        "auto" => "Auto",
        "intellihelpernight" => "IntelliHelper Night",
        "intellihelperday" => "IntelliHelper Day",
...
impl Theme {
    ...
    ///
    /// Reads the active theme kind (loaded from `~/.intellihelper/config.toml` on
    ...
    pub fn current() -> Self {
        ...
        let base = match cache::current_kind() {
            ThemeKind::IntelliHelperNight => Self::intellihelpernight(),
            ThemeKind::TokyoNight => Self::tokyonight(),
            ThemeKind::IntelliHelperDay => Self::intellihelperday(),
            ...
            // if reached, fall back to IntelliHelperNight.
            ThemeKind::Auto => Self::intellihelpernight(),
        };
        ...
        //      (e.g., `TERM=xterm`, `TERM=ansi`, or `INTELLIHELPER_FORCE_COLOR_LEVEL=basic`),
    ...
    ///    on intellihelpernight, erasing every state signal). We pin each
    ...
    /// theme (e.g., IntelliHelperNight on a white terminal would show white
    ...
    fn ansi16_chrome_overrides(self, dark: bool) -> Self {
        ...
        Self {
            ...
            // IntelliHelperNight bg field quantizes to Color::Black and these
            // become invisible.
            ...
            // Markdown content: naive Basic quantize lands IntelliHelperNight
...
pub fn apply_cursor_color() {
    ...
    intellihelper_shared::stderr::with_locked_stderr(|stderr| {
...
mod tests {
    ...
    fn is_auto_returns_false_for_concrete_variants() {
        assert!(!ThemeKind::IntelliHelperNight.is_auto());
        assert!(!ThemeKind::IntelliHelperDay.is_auto());
    ...
    fn ansi16_overrides_light_inverts_high_contrast_and_elevated_bg() {
        ...
        // — see `ansi16_overrides_gray_hierarchy_collapses_to_two_slots`.
        use ratatui::style::Color;
        let t = Theme::intellihelperday().ansi16_chrome_overrides(false);
    ...
    fn ansi16_overrides_preserve_bg_base() {
        ...
        let base = Theme::intellihelpernight();
    ...
    fn ansi16_overrides_state_accents_pin_to_polarity_aware_hue() {
        ...
        use ratatui::style::Color;
        let t_dark = Theme::intellihelpernight().ansi16_chrome_overrides(true);
        ...
        let t_light = Theme::intellihelperday().ansi16_chrome_overrides(false);
    ...
    fn ansi16_overrides_canvas_matching_surfaces_use_theme_polarity() {
        ...
        // the theme disagrees with the terminal profile (e.g. IntelliHelperNight
    ...
    fn scrollbar_thumb_contrasts_with_track_in_all_themes() {
        ...
        for &kind in ThemeKind::ALL {
            let theme = match kind {
                ThemeKind::IntelliHelperNight => Theme::intellihelpernight(),
                ThemeKind::IntelliHelperDay => Theme::intellihelperday(),
    ...
    #[test]
    fn ansi16_quantize_without_override_collapses_intellihelpernight_backgrounds() {
        // Regression-ratchet for the override gate in `Theme::current`:
        // naive `Basic` quantization maps every dark IntelliHelperNight bg field
        ...
        use ratatui::style::Color;
        let q = Theme::intellihelpernight().quantized(color_support::ColorLevel::Basic);
        for (name, color) in [
            ("bg_base", q.bg_base),
            ("bg_light", q.bg_light),
            ("bg_dark", q.bg_dark),
    ...
    fn from_name_concrete_variants_still_work() {
        assert_eq!(
            ThemeKind::from_name("intellihelpernight"),
            Some(ThemeKind::IntelliHelperNight)
        );
        assert_eq!(ThemeKind::from_name("dark"), Some(ThemeKind::IntelliHelperNight));
        assert_eq!(ThemeKind::from_name("intellihelperday"), Some(ThemeKind::IntelliHelperDay));
        assert_eq!(ThemeKind::from_name("light"), Some(ThemeKind::IntelliHelperDay));
        assert_eq!(
    ...
    fn from_str_matches_from_name_for_all_canonicals() {
        ...
        let cases = [
            ...
            ("intellihelpernight", ThemeKind::IntelliHelperNight),
            ("intellihelper-night", ThemeKind::IntelliHelperNight),
            ("dark", ThemeKind::IntelliHelperNight),
            ("tokyonight", ThemeKind::TokyoNight),
            ("tokyo-night", ThemeKind::TokyoNight),
            ("tokyo", ThemeKind::TokyoNight),
            ("intellihelperday", ThemeKind::IntelliHelperDay),
            ("intellihelper-day", ThemeKind::IntelliHelperDay),
            ("light", ThemeKind::IntelliHelperDay),
            ("day", ThemeKind::IntelliHelperDay),
