...
pub use intellihelper_mcp::servers::{
...
use intellihelper_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use intellihelper_mcp::servers as inner;
...
pub(crate) fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    file_utils::events::Event::McpConfigResolved { servers, disabled }
}
