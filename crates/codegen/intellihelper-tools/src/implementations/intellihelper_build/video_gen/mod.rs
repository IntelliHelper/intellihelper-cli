...
const XAI_VIDEO_BASE_MODEL: &str = "intellihelper-imagine-video";
const XAI_VIDEO_QUALITY_MODEL: &str = "intellihelper-imagine-video-1.5-preview";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "intellihelper-videos/";
...
impl VideoGenClient {
    pub fn new(
        ...
        let download_http = intellihelper_extra_ca::with_extra_root_certificates(
...
/// modal instead.
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Video generation is a SuperGrok feature and isn't available on the free or X Basic tier. Let the user know they can unlock image and video generation by upgrading to SuperGrok: https://grok.com/__PROTECT_6__?referrer=intellihelper-build. Do not retry this tool.";
