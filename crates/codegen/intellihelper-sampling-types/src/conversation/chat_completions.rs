...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            x_intellihelper_conv_id: req.x_intellihelper_conv_id,
            x_intellihelper_req_id: req.x_intellihelper_req_id,
            x_intellihelper_session_id: req.x_intellihelper_session_id,
            x_intellihelper_turn_idx: req.x_intellihelper_turn_idx,
            x_intellihelper_agent_id: req.x_intellihelper_agent_id,
            x_intellihelper_deployment_id: req.x_intellihelper_deployment_id,
            x_intellihelper_user_id: req.x_intellihelper_user_id,
            trace: None,
        }
    }
}
