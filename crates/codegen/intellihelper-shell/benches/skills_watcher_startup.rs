...
//!
//! ```text
//! cargo bench -p intellihelper-shell --bench skills_watcher_startup
//! # optional scale:
//! INTELLIHELPER_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p intellihelper-shell --bench skills_watcher_startup
//! ```
//!
...
fn build_fixture(worktree_dirs: usize) -> Fixture {
    ...
    let intellihelper_home = root.path().join("intellihelper-home");
