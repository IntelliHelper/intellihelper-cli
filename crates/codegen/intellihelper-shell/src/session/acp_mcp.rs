...
//!
//! The official `intellihelper-agent-sdk` lets a host define in-process tools (`@tool` /
...
use intellihelper_mcp::acp_transport::AcpReverseInvoker;
use intellihelper_mcp::servers::AcpServerEntry;
