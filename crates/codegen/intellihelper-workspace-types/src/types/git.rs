...
//! `intellihelper_shell::session::git` and `intellihelper_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `intellihelper_shell::session::git::VcsKind`.
...
/// `intellihelper_shell::session::git`.
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
