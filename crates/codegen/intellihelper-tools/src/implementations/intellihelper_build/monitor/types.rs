...
pub struct MonitorEventNotification {
    ...
    /// events inside another session's turn. `None` for legacy / non-intellihelper-build
...
crate::register_resource!("intellihelper_build", "MonitorEventBuffer", MonitorEventBuffer);
