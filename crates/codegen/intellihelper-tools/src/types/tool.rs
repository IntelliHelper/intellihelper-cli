...
///
/// Serializes to snake_case (`intellihelper_build`, `mcp`, …) for the
...
/// (e.g. `"IntelliHelperBuild:read_file"`); only the serde form goes on the wire.
#[derive(
    Debug,
    Clone,
    Copy,
...
pub enum ToolNamespace {
    #[serde(alias = "IntelliHelperBuild")]
    IntelliHelperBuild,
    #[serde(alias = "IntelliHelperBuildConcise")]
    IntelliHelperBuildConcise,
    #[serde(alias = "IntelliHelperBuildHashline")]
    IntelliHelperBuildHashline,
    #[serde(alias = "Codex")]
    Codex,
