...
pub use intellihelper_tools::implementations::intellihelper_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<intellihelper_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: intellihelper_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<intellihelper_shell::sampling::types::ReasoningEffort>,
    },
    DoctorFix {
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> intellihelper_tools::implementations::intellihelper_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: intellihelper_tools::implementations::intellihelper_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
