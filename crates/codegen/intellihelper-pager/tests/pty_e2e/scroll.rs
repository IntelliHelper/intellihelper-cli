...
use intellihelper_pager_pty_harness::PtyHarness;
pub(crate) use intellihelper_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`intellihelper-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `intellihelper-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
...
/// (e.g. `INTELLIHELPER_SCROLL_SPEED`) appended to the controller's env.
