...
use intellihelper_hooks::{dispatcher, result};
...
/// `description` instead.
fn stop_entry_from_task(task: &intellihelper_tools::types::TaskSnapshot) -> StopBackgroundTask {
    let command_text =
...
fn stop_entry_from_subagent(
    summary: &intellihelper_tools::implementations::intellihelper_build::task::types::ActiveSubagentSummary,
) -> StopBackgroundTask {
    StopBackgroundTask {
...
fn stop_cron_from_scheduled(
    task: &intellihelper_tools::implementations::intellihelper_build::scheduler::types::ScheduledTask,
) -> StopSessionCron {
    StopSessionCron {
        id: task.id.clone(),
        schedule:
            intellihelper_tools::implementations::intellihelper_build::scheduler::interval::interval_to_human(
                task.interval_secs,
            ),
...
impl SessionActor {
    ...
    pub(crate) async fn list_active_subagents(
        &self,
    ) -> Vec<intellihelper_tools::implementations::intellihelper_build::task::types::ActiveSubagentSummary> {
    ...
    async fn announce_keep_working(
        ...
        for block in blocks {
            ...
            .await;
            intellihelper_telemetry::session_ctx::log_event(intellihelper_telemetry::events::HookBlocked {
...
mod stop_gate_snapshot_tests {
    ...
    fn task_snapshot(
        kind: intellihelper_tools::computer::types::TaskKind,
    ...
    fn subagent_summary_maps_to_stop_entry() {
        let summary =
            intellihelper_tools::implementations::intellihelper_build::task::types::ActiveSubagentSummary {
    ...
    fn scheduled_task_maps_to_stop_cron() {
        let task =
            intellihelper_tools::implementations::intellihelper_build::scheduler::types::ScheduledTask::new(
                300,
