...
-> [intellihelper_tools::implementations::intellihelper_build::ask_user_question::QuestionOption; 2] {
    use intellihelper_tools::implementations::intellihelper_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
