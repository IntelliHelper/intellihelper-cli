...
//! IntelliHelper to persist important information across sessions. Memory files are
//! stored under `~/.intellihelper/memory/` with workspace-scoped subdirectories
...
//! `INTELLIHELPER_MEMORY=1` environment variable. When disabled, this crate
