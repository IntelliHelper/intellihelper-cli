...
//! `intellihelper-tools/src/implementations/skills/types.rs` (the type the
...
pub enum SkillScope {
    /// cwd/.intellihelper/skills
    Local,
    /// repo_root/.intellihelper/skills
    Repo,
    /// ~/.intellihelper/skills
    User,
    /// ~/.intellihelper/server-skills (synced from the skill store)
    Server,
...
mod tests {
    ...
    // Fixture mirrored field-for-field from the intellihelper-tools SkillInfo
    ...
    fn skill_info_deserializes_full_payload() {
        let raw = serde_json::json!({
            ...
            "metadata": {"team": "infra"},
            "path": "/root/.intellihelper/server-skills/deploy/SKILL.md",
            "scope": "server",
            "config_source": {"type": "user", "path": "/root/.intellihelper/skills"},
            "plugin_name": "infra-plugin",
            "plugin_version": "1.0.0",
            "plugin_root": "/root/.intellihelper/plugins/infra-plugin",
            "plugin_data": "/root/.intellihelper/plugin-data/infra-plugin",
            "allowed_tools": ["bash"],
