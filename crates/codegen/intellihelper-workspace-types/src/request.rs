...
//!   here would force every consumer of `intellihelper-workspace-types`
...
//! (`intellihelper-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `intellihelper-workspace-types`
