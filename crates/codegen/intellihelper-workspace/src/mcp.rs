...
use intellihelper_mcp::servers::{McpClient, parse_mcp_qualified_name};
...
/// Extract a server name from an [`McpError`](intellihelper_mcp::servers::McpError),
/// falling back to `"unknown"`.
pub(crate) fn server_name_from_mcp_error(e: &intellihelper_mcp::servers::McpError) -> &str {
