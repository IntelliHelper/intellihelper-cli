...
pub(crate) fn resolve_worktree_auto_gc_from_settings(
    ...
    use intellihelper_workspace::worktree::worktree_auto_gc_layer_from_settings;
...
"#;
    ...
    fn resolve_worktree_auto_gc_remote_ttl_clamped() {
        ...
        assert_eq!(
            p.min_interval_secs,
            fast_worktree::MIN_INTERVAL_SECS_MIN
        );
    }
    ...
    fn resolve_worktree_auto_gc_upper_clamp_via_resolve() {
        ...
        assert_eq!(
            p.min_interval_secs,
            fast_worktree::MIN_INTERVAL_SECS_MAX
        );
    }
