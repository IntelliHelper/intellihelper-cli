...
impl WorkflowManager {
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                intellihelper_tools::implementations::intellihelper_build::task::types::SubagentEvent::Cancel(
                    intellihelper_tools::implementations::intellihelper_build::task::types::SubagentCancelRequest {
                        parent_session_id: Some(self.session_id.clone()),
                        target: intellihelper_tools::implementations::intellihelper_build::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
mod tests {
    ...
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<intellihelper_tools::implementations::intellihelper_build::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    ) -> intellihelper_tools::implementations::intellihelper_build::task::types::SubagentSpawnRequest {
        use intellihelper_tools::implementations::intellihelper_build::task::types::SubagentEvent;
    ...
    fn complete_spawn(
        req: intellihelper_tools::implementations::intellihelper_build::task::types::SubagentSpawnRequest,
    ) {
        use intellihelper_tools::implementations::intellihelper_build::task::types::SubagentResult;
        let id = req.id.clone();
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            intellihelper_tools::implementations::intellihelper_build::task::types::ModelOverrideProvenance::Tool,
