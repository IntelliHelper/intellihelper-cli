//! Compacted-history assembly (intellihelper-build's rebuild structure, generic).
//!
...
//! ```
//!
//! intellihelper-build is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // intellihelper-build keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn intellihelper_build_order_recent_before_summary() {
