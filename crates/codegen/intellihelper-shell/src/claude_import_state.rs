...
//
// State is persisted to `~/.intellihelper/claude_import_state.json`.
...
use intellihelper_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.intellihelper/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::intellihelper_home::intellihelper_home().join("claude_import_state.json")
}
