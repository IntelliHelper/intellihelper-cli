...
pub(crate) fn loaded_plugin_to_info(plugin: &intellihelper_agent::plugins::LoadedPlugin) -> PluginInfo {
    use intellihelper_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &intellihelper_agent::plugins::PluginOrigin) -> PluginOrigin {
    use intellihelper_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
...
mod tests {
    use super::*;
    use intellihelper_agent::plugins::PluginOrigin as AgentOrigin;
    use intellihelper_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> intellihelper_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        intellihelper_agent::plugins::LoadedPlugin {
