...
//! intellihelper-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use intellihelper_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use intellihelper_workspace::session::file_state::FileStateHandle;
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> intellihelper_tools::implementations::intellihelper_build::task::types::SubagentForegroundWait {
    intellihelper_tools::implementations::intellihelper_build::task::types::SubagentForegroundWait::new(
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn intellihelper_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<intellihelper_tools::implementations::intellihelper_build::monitor::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<intellihelper_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    ...
    pub fn new(
        ...
        let session_env = intellihelper_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
