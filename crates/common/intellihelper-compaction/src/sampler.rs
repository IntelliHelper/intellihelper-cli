...
/// matching the literal messages produced by the IntelliHelper chat sampler —
...
/// Implemented by each harness's sampler adapter; intellihelper-build wires its own
/// transport.
///
