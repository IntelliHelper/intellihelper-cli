...
/// The base prompt template source, exposed for `intellihelper prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `intellihelper prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard intellihelper-build tool kinds.
