...
//! in-sandbox manifest contract (`{workspace}/.intellihelper/repos.json`).
//!
...
pub const REPOS_MANIFEST_RELATIVE_PATH: &str = ".intellihelper/repos.json";
...
impl RepoManifest {
    ...
    /// Parse bytes from `{workspace}/.intellihelper/repos.json`.
    ...
    fn manifest_round_trip() {
        let manifest = RepoManifest::new(vec![
            ProvisionedRepo {
                ...
                session_branch: "intellihelper/s1".into(),
            },
            ProvisionedRepo {
                name: "lib".into(),
