...
// its wire types live in `intellihelper_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use intellihelper_workspace_types::rpc::fs::FsReadEncoding;
...
pub use intellihelper_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
