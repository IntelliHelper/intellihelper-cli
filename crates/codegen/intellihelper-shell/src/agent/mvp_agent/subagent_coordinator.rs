...
//! The shared coordinator actor lives in `intellihelper-tools`; this module plugs
...
impl intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildRunner
    for ShellChildRunner
{
    ...
    type RunFuture = intellihelper_tools::implementations::intellihelper_build::task::coordinator::LocalBoxFuture<
        intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildRunOutput<
            Self::CompletionData,
        >,
    >;
    type ValidateFuture =
        intellihelper_tools::implementations::intellihelper_build::task::coordinator::LocalBoxFuture<
            intellihelper_tools::implementations::intellihelper_build::task::types::SubagentValidateTypeOutcome,
        >;
    type DescribeFuture =
        intellihelper_tools::implementations::intellihelper_build::task::coordinator::LocalBoxFuture<
            intellihelper_tools::implementations::intellihelper_build::task::types::SubagentDescribeOutcome,
        >;
    fn run(
        &self,
        run: intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildRunRequest<
            Self::Control,
        >,
    ) -> Self::RunFuture {
        let agent_ref = self.agent_ref.clone();
        Box::pin(async move {
            let intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildRunRequest {
                request,
                cancellation,
                reporter,
            } = run;
            ...
            let Some(mut ctx) = this.try_build_subagent_spawn_context(&parent_sid) else {
                ...
                return intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildRunOutput {
                    result: intellihelper_tools::implementations::intellihelper_build::task::types::SubagentResult {
                        success: false,
                        error: Some(
        ...
        Box::pin(async move {
            ...
            match this.try_build_subagent_spawn_context(&parent_session_id) {
                ...
                None => {
                    ...
                    intellihelper_tools::implementations::intellihelper_build::task::types::SubagentDescribeOutcome::Unavailable
                }
            }
        })
    }
    fn on_completed(
        &self,
        completion: intellihelper_tools::implementations::intellihelper_build::task::coordinator::ChildCompletion<
            Self::CompletionData,
        >,
    ) {
...
impl MvpAgent {
    ...
    /// [`SubagentCoordinator`](intellihelper_tools::implementations::intellihelper_build::task::coordinator::SubagentCoordinator)
    ...
    pub(super) fn start_subagent_coordinator(&self) {
        ...
        let config =
            intellihelper_tools::implementations::intellihelper_build::task::coordinator::CoordinatorConfig {
                foreground_budget:
                    intellihelper_tools::implementations::intellihelper_build::task::backend::env_duration_or(
                        "INTELLIHELPER_SUBAGENT_AWAIT_BUDGET_MS",
        ...
        tokio::task::spawn_local(
            intellihelper_tools::implementations::intellihelper_build::task::coordinator::SubagentCoordinator::new(
                    rx,
                    runner,
                    config,
                )
                ...
                ps.as_ref()
                    ...
                    .unwrap_or_else(|| {
                        let cwd = ps
                            ...
                            .map(|h| std::path::PathBuf::from(&h.info.cwd))
                            .unwrap_or_default();
                        std::sync::Arc::new(intellihelper_workspace::file_system::LocalFs::new(cwd))
                    }),
                ps.as_ref()
