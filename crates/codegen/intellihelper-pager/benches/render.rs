//! Criterion benchmarks for the intellihelper-pager rendering pipeline.
//!
...
use intellihelper_pager::scrollback::render::render_scrolled_entries_with_scratch;
use intellihelper_pager::scrollback::wrappers::EntryRenderer;
use intellihelper_pager::scrollback::{
