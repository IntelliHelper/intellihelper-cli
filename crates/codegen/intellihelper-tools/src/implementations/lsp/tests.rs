...
/// `cargo test -p intellihelper-shell e2e_real_typescript_language_server -- --ignored`
#[ignore]
#[tokio::test(flavor = "current_thread")]
...
/// (which changes only when intellihelper restarts it), the number of server processes,
...
///   cargo test -p intellihelper-tools e2e_real_roslyn_survives_editing -- --ignored --nocapture
/// ```
#[ignore]
#[tokio::test(flavor = "multi_thread")]
