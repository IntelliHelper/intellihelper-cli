...
use intellihelper_shell::auth::{AuthManager, AuthMode, IntelliHelperAuth, GrokComConfig};
use intellihelper_shell::heap_profile::{
...
use intellihelper_test_support::{EnvGuard, MockInferenceServer};
use intellihelper_version::TEST_VERSION_ENV;
...
fn assert_storage_auth(uploads: &[intellihelper_test_support::mock_server::StorageUpload]) {
    for u in uploads {
        assert_eq!(
