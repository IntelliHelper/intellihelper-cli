...
//! `intellihelper-workspace`. Wire types live in
//! `intellihelper_workspace_types::rpc`; this crate adds the connected-state
...
use intellihelper_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use intellihelper_workspace_types::rpc::code_nav::{
...
use intellihelper_workspace_types::rpc::export_github::{ExportGithubReq, ExportGithubResponse};
use intellihelper_workspace_types::rpc::fs::{
...
use intellihelper_workspace_types::rpc::git::{
...
use intellihelper_workspace_types::rpc::hunks::{
...
use intellihelper_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use intellihelper_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use intellihelper_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use intellihelper_workspace_types::rpc::worktree::{
...
use intellihelper_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
/// Check whether a [`ToolError`](tool_runtime::ToolError) indicates
...
mod tests {
    ...
    use intellihelper_workspace_types::rpc::skills::SkillScope;
        ...
        async fn run(&self, _ctx: ToolCallContext, args: Self::Args) -> Result<RawOut, ToolError> {
            ...
            match args.method.as_str() {
                ...
                "workspace.discover_skills" => ok(serde_json::json!([{
                    ...
                    "path": "/workspace/.intellihelper/skills/my-skill/SKILL.md",
                    "scope": "local",
                }])),
    ...
    async fn consume_stream_terminal_returns_ok() {
        ...
        let mut stream = tool_runtime::terminal_only(Ok(typed));
        assert_eq!(
