...
pub(crate) struct ModelsCache {
    ...
    pub(crate) intellihelper_version: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ModelsCacheManager {
    pub(crate) fn new() -> Self {
        Self {
            path: crate::util::intellihelper_home::intellihelper_home().join(MODELS_CACHE_FILE),
            ttl: CACHE_TTL,
        }
    }
    ...
    pub(crate) fn load_fresh(
        ...
        if cache.intellihelper_version.as_deref() != Some(intellihelper_version::VERSION) {
    ...
    /// Per-writer temp path: `~/.intellihelper` is shared across concurrent CLI
