...
use crate::implementations::intellihelper_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::intellihelper_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::intellihelper_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::intellihelper_build::grep::GrepSearchInput;
use crate::implementations::intellihelper_build::image_edit::ImageEditInput;
use crate::implementations::intellihelper_build::image_gen::ImageGenInput;
use crate::implementations::intellihelper_build::list_dir::ListDirInput;
use crate::implementations::intellihelper_build::read_file::ReadFileInput;
use crate::implementations::intellihelper_build::search_replace::SearchReplaceInput;
use crate::implementations::intellihelper_build::todo::TodoWriteInput;
use crate::implementations::intellihelper_build::update_goal::UpdateGoalInput;
use crate::implementations::intellihelper_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::intellihelper_build::web_fetch::WebFetchInput;
use crate::implementations::intellihelper_build::web_search::WebSearchInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::intellihelper_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::intellihelper_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::intellihelper_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::intellihelper_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::intellihelper_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::intellihelper_build::workflow::WorkflowToolInput),
