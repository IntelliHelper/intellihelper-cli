...
//! window containing a [`intellihelper_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`intellihelper_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`intellihelper_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`intellihelper_mcp::servers::ClientStateKind::Empty`]
...
use intellihelper_mcp::servers::{McpClientEventKind, McpServerName};
