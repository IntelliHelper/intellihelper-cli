//! AcpFsAdapter: implements `intellihelper-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates intellihelper-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use intellihelper_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps intellihelper-shell's ACP gateway to satisfy intellihelper-tools' AsyncFileSystem.
///
