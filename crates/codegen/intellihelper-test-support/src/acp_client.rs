//! ACP stdio clients for testing intellihelper sessions end-to-end: the typed
//! [`IntelliHelperStdioClient`] (`agent-client-protocol::ClientSideConnection` —
...
/// Spawn `intellihelper agent stdio` with the sandbox's canonical hermetic environment.
...
fn spawn_agent_process(
    ...
    TestProcess::spawn(
        ...
        TestProcessConfig::new()
            .label("intellihelper agent stdio")
...
/// Drives `intellihelper agent stdio` with verbatim newline-delimited JSON-RPC lines.
///
/// Exists for wire shapes the typed [`IntelliHelperStdioClient`] (`ClientSideConnection`,
