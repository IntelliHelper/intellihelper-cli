...
/// `filename`, `path`, `metadata`) that the IntelliHelper SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the IntelliHelper SLOP converter to
    ...
    /// - `path`: file path on the IntelliHelper Computer filesystem
