...
//! string/text manipulation. Harness-bound extraction (IntelliHelper chat's
//! `IntelliHelperConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `IntelliHelperMessage` assembly) stays in the harness crate.
